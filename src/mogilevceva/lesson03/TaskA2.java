...
class TaskA2 {
    public static void main(String[] args) {
        String s = "Мое любимое стихотворение:";
        String a = "Подруга дней моих суровых,";
        String b = "Голубка дряхлая моя";
        String c = "Одна в глуши лесов сосновых";
        String d = "Давно, давно ты ждешь меня.";
